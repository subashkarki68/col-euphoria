...
export const Destinations = () => {
  ...
  return (
    <View className="mb-64 flex w-full flex-col items-center bg-col-primary-light dark:bg-col-primary-dark">
      <View className="mb-24 flex flex-col items-center gap-6 px-4">
